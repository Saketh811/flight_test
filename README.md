...
In this project, my group developed an Oozie workflow to process and analyze a large volume of flight data.

We use three MapReduce programs and run them fully distributed on AWS EC2 clusters
